...
import { MessageSquare, Settings, Users, Radio, FileJson, UsersRound, Database, Tag, ClipboardList, Activity } from 'lucide-react';

type View = 'feed' | 'tasks' | 'traces' | 'peers' | 'schemas' | 'groups' | 'retention' | 'topics' | 'settings';
